...
public class FileUtils {
    ...
    private void initRollBackMap() {
        ...
        internalProp.forEach((k, v) -> {
            rollbackMap.putIfAbsent(Objects.toString(k), Objects.toString(v));
        });
        externalProp.forEach((k, v) -> {
            rollbackMap.putIfAbsent(Objects.toString(k), Objects.toString(v));
        });
    ...
    private Map<String, String> rollbackMap = new HashMap<>();
